...
${TBIN}/test_2: ${TBIN} ${OBJ}/WyrazenieZesp.o ${OBJ}/LZespolona.o ${OBJ}/Statystyki.o 
	g++ -o ${TESTS}/bin/test_2 ${FLAGS} -I${TESTS}/doctest ${TESTS}/test2.cpp ${OBJ}/WyrazenieZesp.o ${OBJ}/LZespolona.o ${OBJ}/Statystyki.o 
